...
# %% [markdown]
# Let's note the hierarchy of the design now:
# - Design
#     - Design_Body
#     - Component
...
# %% [markdown]
# Because we stored the reference to Component in the variable `comp` and did an operation that changed the design, `comp` is now stale. Let's try to reference it in a copy.
...
# [DesignFileFormat](https://geometry.docs.pyansys.com/version/stable/api/ansys/geometry/core/designer/design/DesignFileFormat.html)
