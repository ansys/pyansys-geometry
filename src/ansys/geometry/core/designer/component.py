...
class Component:
    ...
    def __init__(
        ...
        master_comp: Optional[MasterComponent] = None,
        ...
        if template:
            ...
            if not master_comp:
                ...
                master = MasterComponent(
                    uuid.uuid4(),
                    f"master_{name}",
                    template._master_comp.part,
                    template._master_comp.transform,
                )
                self._master_comp = master
        ...
        self._master_comp.occurrences.append(self)
    ...
    def bodies(self) -> List[Body]:
        ...
        bodies = []
        for body in self._master_comp.part.bodies:
    ...
    def __create_children(self, template: "Component") -> None:
        ...
        for template_comp in template.components:
            ...
            new = Component(
                ...
                master_comp=template_comp._master_comp,
            )
    ...
    def get_world_transform(self) -> Matrix44:
        ...
        return self.parent_component.get_world_transform() * self._master_comp.transform
    ...
    def modify_placement(
        ...
        self._master_comp.transform = grpc_matrix_to_matrix(response.matrix)
    ...
    def extrude_sketch(
        ...
        self._master_comp.part.bodies.append(tb)
