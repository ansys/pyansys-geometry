...
def test_check_is_pint_unit():
    ...
    with pytest.raises(TypeError, match="The parameter 'not_a_pint_unit' should be a pint.Unit object."):
...
def test_check_ndarray_is_float_int():
    ...
    with pytest.raises(TypeError, match="The numpy.ndarray provided should contain float or integer values."):
        check_ndarray_is_float_int(arr_strs)
    
    with pytest.raises(TypeError, match="The numpy.ndarray 'arr_strs' should contain float or integer values."):
...
def test_check_is_float_int():
    ...
    with pytest.raises(TypeError, match="The parameter provided should be a float or an integer value."):
        check_is_float_int(str)
    
    with pytest.raises(TypeError, match="The parameter 'str' should be a float or an integer value."):
        check_is_float_int(str, "str")

    with pytest.raises(TypeError, match="The parameter 'num_complex' should be a float or an integer value."):
