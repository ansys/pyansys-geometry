PyAnsys Geometry
================
|pyansys| |python| |GH-CI| |codecov| |MIT| |black| |pre-commit|
...
.. |pypi-downloads| image:: https://img.shields.io/pypi/dm/ansys-geometry-core.svg
   :target: https://pypi.org/project/ansys-geometry-core/
   :alt: PyPI Downloads

.. |conda-downloads| image:: https://img.shields.io/conda/dn/conda-forge/ansys-geometry-core
   :target: https://anaconda.org/conda-forge/ansys-geometry-core
   :alt: Conda Downloads
