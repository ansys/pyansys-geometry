...
def sketch_circle_to_grpc_circle(circle: SketchCircle, plane: Plane) -> GRPCCircle:
    """Marshals a :class:`SketchCircle <ansys.geometry.core.sketch.circle.SketchCircle>` to a Circle gRPC message of the Geometry Service.
...
def point2D_to_grpc_point(plane: Plane, point2d: Point2D) -> GRPCPoint:
    """Marshals a :class:`Point2D <ansys.geometry.core.math.point.Point2D>` to a Point gRPC message of the Geometry Service.
