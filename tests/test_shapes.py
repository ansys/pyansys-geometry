...
def test_create_line_no_sketch():
    ...
    line_2 = LineShape(origin=origin, direction=direction_x_vector3D)
...
def test_create_segment_no_sketch():
    ...
    segment_2 = SegmentShape.from_origin_and_vector(start_2, vector_2, vector_units=UNITS.meter)
    ...
    segment_2b = SegmentShape.from_origin_and_vector(start_2b, vector_2b, vector_units=UNITS.mm)
    ...
    segment_3 = SegmentShape(start_3, end_3)
